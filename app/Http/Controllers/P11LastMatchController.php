...
class P11LastMatchController extends Controller
{

    public function lastmatch()
    {
        $url = 'https://www.fussball.de/ajax.team.prev.games/-/mode/PAGE/team-id/02M4J5KE40000000VS5489B1VVVHS1D7';
        ...
        if ($tables->length > 0) {
            ...
            $datalastmatchp11 = $this->score($data);            
        }
        return $datalastmatchp11;
