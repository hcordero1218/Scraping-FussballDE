...
class PFEMLastMatchController extends Controller
{

    public function lastmatch()
    {
        $url = 'https://www.fussball.de/ajax.team.prev.games/-/mode/PAGE/team-id/02M4JASNS0000000VS5489B1VVVHS1D7';
        ...
        if ($tables->length > 0) {
            ...
            $datalastmatchpfem = $this->score($data);            
        }
        return $datalastmatchpfem;
